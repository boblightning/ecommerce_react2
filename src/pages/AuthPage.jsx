...
import { connect } from 'react-redux' //untuk menghubungkan fungsi reducer dengan actions
...
export default connect(null,{loginAction}) (AuthPage); //null digunakan untuk mengambil data dari reducer, param2 jika ingin menyimpan data ke reducer
